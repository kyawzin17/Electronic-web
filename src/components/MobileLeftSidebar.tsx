            ...
            <div className="flex-1 overflow-y-auto" style={{ height: 'calc(100% - 73px)' }}>
                        ...
                        {categories.map((cat: string) => {
                            const hasMatchingItems = docArray
                                ...
                                .some((item: any) => searchTerm === "" || item.name.toLowerCase().includes(searchTerm.toLowerCase()));
                                    ...
                                    {(openCategory === cat || shouldAutoExpand) && (
                                        <div className="flex flex-col ml-4 mt-1 border-l border-slate-200 dark:border-slate-700">
                                            {docArray
                                                ...
                                                {docArray
                                                    .filter((item: any) => item.category === cat)
                                                    .filter((item: any) => searchTerm === "" || item.name.toLowerCase().includes(searchTerm.toLowerCase())).length === 0 && (
