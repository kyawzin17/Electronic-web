...
import "../App.css";
import image from "../../public/docs/images/diode1.webp";
...
function Timeline() {
  ...
  return (
    <div className="mt-4 md:mt-10">
        ...
        {timelineData.map((item, index) => (
          ...
          >
            ...
            <div className="timeline-content hover:translate-y-5">
                <h3 className='text-xl font-semibold font-serif text-text-main'>{item.desc}</h3>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className='w-full flex justify-center items-center gap-2 py-2 mb-18'>
            <h3 ref={textRef} className='text-lg font-medium font-serif text-secondary'></h3>
        </div>
